...
const LOYALTY_DISCOUNTS = [
  ...
  { weeks: 8, discount: 0.1, label: "Gold Rider" },
  { weeks: 12, discount: 0.15, label: "Elite Rider" },
  { weeks: 24, discount: 0.2, label: "Legend Rider" },
];
...
const RATE_LIMITS = {
  ...
  WEBHOOK: { windowMs: 60 * 1000, max: 50 },
};
...
const BUSINESS_RULES = {
  ...
  MAX_PAYOUT_AS_PERCENT_OF_WEEKLY: 0.6,
  ...
  LOYALTY_POOL_CONTRIBUTION_PERCENT: 0.1, // 10% of unclaimed premiums
};
